...
const PlaneCrudTableFlight = () => {
  ...
  const handleAddFlight = () => {
    window.location.href = '/dashboard/AddFlight';
        ...
        <div className="table-title">
          <div className="row">
            ...
            <div className="col-sm-6">
              ...
              <button className="btn btn-success" data-toggle="modal" onClick={handleAddFlight}>
                <i className="material-icons">&#xE147;</i> <span>Add New Flight</span>
              </button>
          ...
          {passengers.map((passenger) => (
              <tr key={passenger.id}>
                ...
                <a href='/dashboard/ViewPassenger' className="view" data-toggle="modal" >
                  ...
                  <a href="#deletePassengerModal" className="delete" data-toggle="modal" onClick={() => handleDeleteFlight(passenger.passengerId)}>
...
export default PlaneCrudTableFlight;
